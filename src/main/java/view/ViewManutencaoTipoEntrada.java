 ...
 * @author Ruan
 */
public class ViewManutencaoTipoEntrada extends ViewManutencao<TipoEntrada> {

    public ViewManutencaoTipoEntrada() {
        initComponents();
    }
    ...
    @Override
    public TipoEntrada getModelFromDadosTela() {
        TipoEntrada model = new TipoEntrada();
