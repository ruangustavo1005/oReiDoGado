 ...
 * @author Ruan
 */
public class ViewManutencaoClassificacao extends ViewManutencao<Classificacao> {

    public ViewManutencaoClassificacao() {
        initComponents();
    }
    ...
    @Override
    public Classificacao getModelFromDadosTela() {
        Classificacao model = new Classificacao();
