 ...
 */
@Entity
public class TipoEntrada extends Model implements ListagemMaqueada, ListagemFiltravel {
    ...
    public TipoEntrada(int id, String descricao) {
        this.setId(id)
    ...
    public TipoEntrada setId(int id) {
        this.id = id;
        return this;
    }
    ...
    public TipoEntrada setDescricao(String descricao) {
