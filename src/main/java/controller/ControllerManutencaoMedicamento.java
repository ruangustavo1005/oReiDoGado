...
import view.ViewManutencaoMedicamento;

/**
 * @author Ruan
 */
public class ControllerManutencaoMedicamento extends ControllerManutencao<Medicamento, ViewManutencaoMedicamento, Dao> {

    public ControllerManutencaoMedicamento(Controller caller, boolean visualizacao) {
    ...
    @Override
    public ViewManutencaoMedicamento getInstanceView() {
        return new ViewManutencaoMedicamento();
    }
